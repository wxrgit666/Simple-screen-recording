...
namespace SimpleRecorder
{
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            // 绑定会员状态
            App.Membership.PropertyChanged += Membership_PropertyChanged;
        ...
        private void Membership_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            UpdateMembershipUI();
        }
        ...
        {
            // 隐藏所有会员相关UI，让所有功能都可用
            MembershipSection.Visibility = Visibility.Collapsed;
        }
        ...
        {
            Frame.Navigate(typeof(MembershipPage));
        }
